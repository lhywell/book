...
#### res.end(data)
结束响应循环，这个方法是来自Node的[response.end](https://nodejs.org/dist/latest-v8.x/docs/api/http.html#http_response_end_data_encoding_callback)
如果data存在的话，会调用response.write(data, encoding)



上一页：[Request](https://github.com/lhywell/book/tree/master/express4.x/1.2README.md)